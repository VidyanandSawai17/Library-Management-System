...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:#000080"><h1 align="center"><marquee>Vidya Bharati Mahavidyalaya Amravati</marquee></td></h1>
      </tr>
      <tr>
        <td style="color:black" align="center"><font size="6"><b><marquee>Welcome To Online Library System</marquee></font></b></td>
      </tr>
    </table>
  </div>
    <br>
    ...
    <form method="post" action="">
      <div  class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:360px; margin-left:13%;margin-top:15px;background-color:white">
        ...
        <fieldset align="center" style="  background:rgba(0,0,0,0.38);color:black;" class="five" class="one">
          <div class="boxfour">
        ...
        <table style="font-size:16pt;width:300px;height:50px;margin-right:45px;" align="Right">
          ...
          <tr>
            <td style="font-size:16pt"><b>New User ?</b></td>


            <td spt"><a href="registration.php" style="color:white">Sign Up</a></td>
          </tr>
          <tr>
            <td ><br></td>
            <td><br></td>
    ...
    <div class="boxthree" style="background-color:#20B2AA; border:solid 1px ;border-radius: 1px; width:73.5%; height:50px; margin-left:13%; margin-top:15px" >
      <marquee><h6 style="line-height:1px;"><p><font size="5"><I>Thank You For Using This System.</I></font></p></h6></marquee>
