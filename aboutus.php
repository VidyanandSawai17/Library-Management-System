...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
          <td style="color:#00008B"><h1 align="center"><marquee><i>Welcome To Online Library System</i></marquee></h1></td>
        </tr>
        <tr>
  ...
  <div class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:84%; height:850px; margin-left:10%;margin-top:10px;background-color:white">
      ...
      <h1 style="color:blue;text-align:center;background:rgba(255, 255, 255, 0.24)">ABOUT OUR ONLINE LIBRARY MANAGEMENT SYSTEM PROJECT </h1>
...
:30%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px #fc7af7;border-radius:10px;padding:3%;font-size:15px;height:200px;"><marquee direction="up" scrolldelay="200" >
         ...
         <tr><td><br/></td><td>1. Vidyanand Sawai</td><td><br/></td><td> Role = ( UI  Developer + Backend Developer )
        </td><td><br/></td></tr>
         ...
         <tr><td><br/></td><td>2. Prajwal Lawankar</td><td><br/></td><td>Role  = ( UI  Developer )</td><td><br/></td></tr>
            
            <br/>
            <hr>
          
          
           <tr><td><br/></td><td>3. Monis Syyed</td><td><br/></td><td>Role = ( UI  Developer ) </td><td><br/></td></tr>
        ...
        <div  style="background-color:orange; border:solid 2px orange;border-radius: 10px; width:84%; height:40px; margin-left:10%; margin-top:15px" >
          <marquee behavior="alternate" direction="right" loop="1" style="margin-right:38%" align="center"><h6 style="line-height:1px;"><p><font size="5"><I>Thank You For Using This System.</I></h6></marquee>
