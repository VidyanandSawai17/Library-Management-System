...
<body>
  ...
  <div class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:84%; height:400px; margin-left:0%;margin-top:10px;background-color:white">
      
      
      
    <fieldset  style ="height:320px; width:650px;overflow:auto" class="three"  >
      <legend align="center" style="color:#000000"><b><u>Your Books</u></b></legend>
    ...
    <table width="100%" height="310px" border="1"  align="center" style="color:white;  background:rgba(0,0,0,0.38);box-shadow:0px 0px 15px lightblue;">
      <tr>
        ...
        <div  style="background-color:orange; border:solid 2px orange;border-radius: 10px; width:84%; height:60px; margin-left:0%; margin-top:25px" >
          <p ><h6 style="line-height:px;"><p><font size="3"><I><marquee direction = "right"> Vidyanand Sawai... </marquee<</I></font></p></h6></p>
